      ...
      <AnimatePresence>
        {isRecruiterMode && (
          <motion.div
            ...
            className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[100] w-full max-w-fit px-6"
          >
            <div className="bg-black/80 backdrop-blur-xl border border-[#ffaa00]/30 rounded-2xl p-2 flex items-center gap-2 shadow-[0_0_50px_-12px_rgba(255,170,0,0.4)]">
              {/* Status Indicator */}
              <div className="flex items-center gap-2 px-4 py-2 bg-[#ffaa00]/10 rounded-xl border border-[#ffaa00]/20 mr-2">
                <div className="w-2 h-2 rounded-full bg-[#ffaa00] animate-pulse" />
                <span className="text-[#ffaa00] text-xs font-black uppercase tracking-widest whitespace-nowrap">
              ...
              <div className="flex items-center gap-1">
                <a
                  ...
                  download
                  className="p-3 rounded-xl hover:bg-[#ffaa00] hover:text-black text-white transition-all group relative"
